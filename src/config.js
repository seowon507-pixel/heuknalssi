...
export const CROPS = {
  lettuce: {
    ...
    stages: [
      ...
      { key: 'seedling', name: '어린 상추',     daysRequired: 6 },
      { key: 'growing',  name: '자라는 상추',   daysRequired: 12 },
  ...
  cucumber: {
    ...
    stages: [
      ...
      { key: 'flower',   name: '오이꽃',        daysRequired: 12 },
  ...
  potato: {
    ...
    stages: [
      ...
      { key: 'seedling', name: '감자 잎',       daysRequired: 6 },
      { key: 'growing',  name: '알 굵는 감자',  daysRequired: 12 },
  ...
  apple: {
    ...
    emoji: '🍎',
    stages: [
      { key: 'seed',     name: '사과 씨앗',       daysRequired: 0 },
      { key: 'sprout',   name: '사과 새싹',       daysRequired: 3 },
      { key: 'sapling',  name: '사과 묘목',       daysRequired: 6 },
  ...
  pear: {
    ...
    emoji: '🍐',
    stages: [
      { key: 'seed',     name: '배 씨앗',        daysRequired: 0 },
      { key: 'sprout',   name: '배 새싹',        daysRequired: 3 },
      { key: 'sapling',  name: '배 묘목',        daysRequired: 6 },
